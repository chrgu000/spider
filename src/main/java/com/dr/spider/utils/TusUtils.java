...
public class TusUtils {
      ...
      TusExecutor executor = new TusExecutor() {
        ...
        protected void makeAttempt() throws ProtocolException, IOException {
          ...
          do {
            ...
            logger.debug("Upload at {}.", String.format("%06.2f%%", progress));
  ...
  public static void main(String[] args) throws Exception {
    ...
    metadata.put("token",
        "dytWbllXYUhJS1ZyMVdpZTFwQVhnUzRxdDVOU1l3bkZZS0F3cVhZOE1zdVJrM1E3NXFEK04xM1p1SU11d3habWh4a1J5LzV2UFdGY2w2Qk9zdz09Om9PMUs0TWpqeHJlb3FFa2VwZ2VKYnc9PQ");
